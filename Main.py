...
.ai-n{font-size:12px;font-weight:600;color:#0f172a;}
.ai-s{font-size:9px;color:#94a3b8;}
...
.at{font-size:10px;font-weight:600;color:#0f172a;}
.ad{font-size:9px;color:#64748b;line-height:1.3;margin-top:1px;}
.atm{font-size:8px;color:#cbd5e1;margin-top:3px;}
...
with st.sidebar:
    ...
    <div style="padding:14px 10px 10px;">
        <div style="display:flex;align-items:center;gap:7px;margin-bottom:16px;">
            ...
            <div>
                <div style="font-size:11px;font-weight:700;color:white;">Green Finance</div>
                <div style="font-size:8px;color:#475569;">Intelligence</div>
            </div>
        </div>
    ...
    st.markdown("""
    <div style="margin:12px 8px 6px;">
        <div style="background:#1e293b;border-radius:8px;padding:10px;">
            <div style="font-size:8px;color:#475569;text-transform:uppercase;letter-spacing:1px;margin-bottom:3px;">S&P 500</div>
            <div style="font-size:18px;color:white;font-weight:700;">5,309.01</div>
            <div style="font-size:10px;color:#22c55e;">▲ +0.78% today</div>
        </div>
        <div style="background:#1e293b;border-radius:8px;padding:8px;margin-top:6px;display:flex;align-items:center;gap:7px;">
            ...
            <div>
                <div style="font-size:10px;color:white;font-weight:500;">Green Finance</div>
                <div style="font-size:8px;color:#475569;">Data Engineer</div>
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
with h2:
    st.markdown(f"""
    <div style="display:flex;justify-content:flex-end;padding-top:3px;">
...
st.markdown("""
<div style="text-align:center;padding:8px;color:#94a3b8;font-size:9px;border-top:1px solid #f1f5f9;margin-top:6px;">
