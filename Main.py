...
.ai-box{background:white;border-radius:16px;border:1px solid #e2e8f0;overflow:hidden;margin-bottom:8px;box-shadow:0 1px 4px rgba(0,0,0,0.04);}
.ai-h{padding:14px 16px;display:flex;align-items:center;justify-content:space-between;}
.ai-robot{width:40px;height:40px;border-radius:12px;background:linear-gradient(135deg,#059669,#10b981);display:flex;align-items:center;justify-content:center;font-size:18px;}
.ai-n{font-size:14px;font-weight:700;color:#0f172a;}
.ai-s{font-size:10px;color:#94a3b8;}
.beta{background:#059669;color:white;padding:2px 8px;border-radius:20px;font-size:9px;font-weight:700;text-transform:uppercase;margin-left:6px;}
.ai-body{padding:0 16px 14px;}
.amsg{background:#f8fafc;border:1px solid #f1f5f9;border-radius:10px;padding:10px 12px;font-size:12px;line-height:1.6;color:#334155;margin-bottom:8px;}
.umsg{background:linear-gradient(135deg,#059669,#10b981);color:white;border-radius:10px;padding:10px 12px;font-size:12px;margin-bottom:8px;margin-left:10%;line-height:1.5;}

.qa-title{font-size:12px;font-weight:600;color:#0f172a;margin:12px 0 8px;}
.qa-btn{display:flex;align-items:center;gap:8px;background:white;border:1px solid #e2e8f0;border-radius:20px;padding:8px 14px;font-size:12px;color:#334155;cursor:pointer;width:100%;margin-bottom:6px;}
.qa-btn:hover{background:#f0fdf4;border-color:#86efac;color:#15803d;}
...
.stButton button{border-radius:20px !important;font-size:11px !important;font-weight:500 !important;border:1px solid #e2e8f0 !important;background:white !important;color:#334155 !important;padding:7px 12px !important;}
...
# SECTOR + ALERTS + AI  — tre kolona poshtë
col1, col2, col3 = st.columns([5,5,6], gap="medium")
...
with col2:
    ...
    if lg2:
        ...
        st.markdown("""<div class="alrt" style="border-left:3px solid #22c55e;margin-bottom:4px;">
            ...
            <div><div class="at">ESG Healthy</div><div class="ad">All stable</div>
